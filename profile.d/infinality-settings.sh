...
# INFINALITY_FT_STEM_ALIGNMENT_STRENGTH                    {{{2
#
...
# INFINALITY_FT_STEM_FITTING_STRENGTH                      {{{2
#
# This performs analysis on each glyph and determines an amount
...
# INFINALITY_FT_STEM_SNAPPING_SLIDING_SCALE                {{{2
#
...
# INFINALITY_FT_USE_KNOWN_SETTINGS_ON_SELECTED_FONTS       {{{2
#
...
# INFINALITY_FT_CHROMEOS_STYLE_SHARPENING_STRENGTH         {{{2
#
...
# INFINALITY_FT_WINDOWS_STYLE_SHARPENING_STRENGTH          {{{2
#
...
# INFINALITY_FT_AUTOHINT_SNAP_STEM_HEIGHT                  {{{2
#
...
# INFINALITY_FT_USE_VARIOUS_TWEAKS                         {{{2
#
...
# INFINALITY_FT_GAMMA_CORRECTION                           {{{2
#
...
# INFINALITY_FT_GRAYSCALE_FILTER_STRENGTH                  {{{2
#
...
# INFINALITY_FT_FRINGE_FILTER_STRENGTH                     {{{2
#
...
# INFINALITY_FT_AUTOHINT_HORIZONTAL_STEM_DARKEN_STRENGTH   {{{2
#
...
# INFINALITY_FT_AUTOHINT_VERTICAL_STEM_DARKEN_STRENGTH     {{{2
#
...
# INFINALITY_FT_AUTOHINT_INCREASE_GLYPH_HEIGHTS            {{{2
#
...
# INFINALITY_FT_GLOBAL_EMBOLDEN_*_VALUE                    {{{2
...
# OS X                       {{{2
# XXX:  Needs work.  Also liable to crash applications.
...
export INFINALITY_FT_FILTER_PARAMS="5 35 45 35 5"
export INFINALITY_FT_STEM_ALIGNMENT_STRENGTH=25
export INFINALITY_FT_STEM_FITTING_STRENGTH=25
export INFINALITY_FT_STEM_SNAPPING_SLIDING_SCALE=0
export INFINALITY_FT_USE_KNOWN_SETTINGS_ON_SELECTED_FONTS=false
...
export INFINALITY_FT_USE_VARIOUS_TWEAKS=false
export INFINALITY_FT_GAMMA_CORRECTION="1000 80"
export INFINALITY_FT_BRIGHTNESS="-35"
export INFINALITY_FT_CONTRAST="0"
...
export INFINALITY_FT_AUTOHINT_INCREASE_GLYPH_HEIGHTS=true
export INFINALITY_FT_GLOBAL_EMBOLDEN_X_VALUE=0
export INFINALITY_FT_GLOBAL_EMBOLDEN_Y_VALUE=6
export INFINALITY_FT_BOLD_EMBOLDEN_X_VALUE=12
export INFINALITY_FT_BOLD_EMBOLDEN_Y_VALUE=0
